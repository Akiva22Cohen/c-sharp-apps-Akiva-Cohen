...
namespace c_sharp_apps_Akiva_Cohen.TransportationApp
{
    public class MonitorTransportation
    {
        ...
        public static void MyTest()
        {
            ...
            int passengers;
            foreach (PublicVehicle publicVehicle in publicVehicles)
            {
                Console.WriteLine("===============================================================");
                for (int i = 0; i < 3; i++)
                {
                    passengers = rand.Next(publicVehicle.Seats / 2, publicVehicle.Seats);
                    Console.WriteLine("Upload passengers^ " + passengers);
                    Console.WriteLine();
                    publicVehicle.UploadPassengers(passengers);
        ...
        public static int CountPlains(PublicVehicle[] vehicles)
        {
            ...
            foreach (PublicVehicle publicVehicle in vehicles)
                if (publicVehicle is PassengersAirplain)
                    count++;
